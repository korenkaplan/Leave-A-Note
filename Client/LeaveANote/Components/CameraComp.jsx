        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.buttonContainer}>
            <CustomButton
              ...
              title={'Use Photo'}
              onPress={moveBackToPreviousScreen}
            />
            <CustomButton
              type="alt"
              containerStyle={{width: 150}}
        ...
        <View style={{flex: 1, backgroundColor: 'black', alignItems: 'center'}}>
          ...
          <View
            style={{
              ...
              borderTopColor: buttonMain.text,
              borderTopWidth: 2,
              height: '20%',
              width: '100%',
            }}>
            <Slider
              ...
              thumbProps={{
                children: (
                  <Badge
                    textStyle={{color: buttonMain.background}}
                    badgeStyle={{
            ...
            <View
              ...
              <TouchableOpacity onPress={toggleTorch} style={styles.sideButton}>
                <Icon
                  name={isTorch ? 'flash-on' : 'flash-off'}
                  color={buttonMain.background}
                  size={35}
                />
              </TouchableOpacity>
